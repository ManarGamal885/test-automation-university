...
public class Chapter4Test {
    ...
    // Using the request specification to prevent repeated code
    ...
    // Specify the request and response specifications in the test using the spec() method
    @Test
    ...
    // Extracting response details using extract() method
    @Test
